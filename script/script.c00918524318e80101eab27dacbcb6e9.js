...
(function (illa) {
    var StringUtil = (function () {
        ...
        StringUtil.removeDoubleSpaces = function (str) {
                ...
                for (var i = 0, n = wordlist.words.length; i < n; i++) {
                    ...
                    arrkup.push([
                        ...
                        [
                            ...
                            [
                                'input/', {
                                    type: 'number', 'class': 'form-control', value: word.lang1Count, min: 0, max: 9, step: 1,
                        ...
                        [
                            ...
                            [
                                'input/', {
                                    type: 'number', 'class': 'form-control', value: word.lang2Count, min: 0, max: 9, step: 1,
                    ...
                    if (existingWord.lang1 == newWord.lang1 || existingWord.lang2 == newWord.lang2) {
                        if (existingWord.lang1Count || existingWord.lang2Count) {
                            notifications.warning([
                                'span', 'Ütközést találtam a következő tanulnivaló szóval: ',
                                ['a', { href: '#edit-word-' + (i + 1) }, (i + 1) + ': ' + existingWord.lang1 + ' – ' + existingWord.lang2 + '.']]);
                        } else {
                            notifications.message([
                                'span', 'Ütközést találtam a következő szóval: ',
            ...
            EditWordlistForm.prototype.onEditWordsSaveRequested = function (e) {
                ...
                for (var i = 0, n = rows.length; i < n; i++) {
                    ...
                    if (!newWord.lang1 || !newWord.lang2 || isNaN(newWord.lang1Count) || isNaN(newWord.lang2Count)) {
                        row.addClass('danger');
                        this.editWordsNotifications.error([
                            [], 'Kérlek tölts ki minden mezőt a ', [
                                'a', { href: '#edit-word-' + (i + 1) },
                                i + 1 + '. sorban!']]);
                        return;
                    }
    ...
    (function (ui) {
        ...
        var LearningForm = (function (_super) {
            ...
            LearningForm.prototype.onInputChanged = function (e) {
                this.isCorrect = illa.StringUtil.removeDoubleSpaces(illa.StringUtil.trim(this.getCurrentInput().val())) === this.getCurrentQuestion().answer;
            ...
            LearningForm.prototype.onEndReached = function () {
                ...
                for (var i = this.questionList.questions.length - 1; i >= 0; i--) {
                    ...
                    if (question.isCorrect) {
                        ...
                        if (question.isLang1) {
                            Math.max(++word.lang1Count, mag.Main.PRACTICE_COUNT_MAX);
                        } else {
                            Math.max(++word.lang2Count, mag.Main.PRACTICE_COUNT_MAX);
                        }
                    }
                }
    ...
    var Main = (function (_super) {
        ...
        Main.prototype.onDatabaseOpenSuccess = function (e) {
            ...
            if (this.hasNewVersion) {
                this.startNotifications.message([
                    'span',
